...
<ul>
  <li><strong>Hypervisor Setup:</strong> Create an internal network segment (e.g., Lab-Net).</li>
  <li><strong>pfSense Adapters:</strong>
    <ul>
      <li>Adapter 1 (WAN): NAT (for updates).</li>
      <li>Adapter 2 (LAN): Assigned to Lab-Net.</li>
    </ul>
  </li>
  <li><strong>Client Adapters:</strong> Set both Kali Linux and DVWA network interfaces to Lab-Net.</li>
</ul>
...
<ul>
  ...
  <li>Enable the DHCP Server to automate IP assignment for the lab machines.</li>
</ul>
...
<ul>
  <li>Define Firewall Rules in pfSense to monitor traffic between the attacker and target.</li>
  <li>Enable Packet Logging on the LAN interface to capture attack signatures.</li>
